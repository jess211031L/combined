...
classification_model = load_anomaly_model('models/mushroom_classification_model')
...
def predict():
    ...
    # Redirect to the external site with prediction
    return redirect(f'https://combined-1-z6te.onrender.com?prediction={prediction}')
